      ...
      <aside id="risk-detail" className="h-fit rounded-3xl border border-slate-800 bg-slate-950 p-5 text-white shadow-2xl xl:sticky xl:top-28 lg:p-6">
        ...
        <div className="mt-5 rounded-2xl border border-cyan-300/20 bg-cyan-300/[0.06] p-4">
          ...
          <button
            ...
            disabled={mlLoading}
            className="mt-4 w-full rounded-xl bg-cyan-300 px-4 py-3 text-sm font-black text-slate-950 transition hover:bg-cyan-200 disabled:cursor-not-allowed disabled:opacity-60"
          >
            {mlLoading ? "Running AI analysis..." : "Run AI Risk Analysis"}
          </button>
          {mlError && (
            <div className="mt-3 rounded-xl border border-rose-300/20 bg-rose-300/10 p-3 text-xs font-semibold text-rose-200">
              {mlError}
            </div>
          )}
          {mlResult && (
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="rounded-xl border border-white/10 bg-white/[0.04] p-3">
                <p className="text-[10px] uppercase tracking-wide text-slate-500">ML Risk Score</p>
                <p className="mt-1 text-2xl font-black text-white">{mlResult.risk_score}/100</p>
              </div>
              <div className="rounded-xl border border-white/10 bg-white/[0.04] p-3">
                <p className="text-[10px] uppercase tracking-wide text-slate-500">Risk Level</p>
                <p className="mt-1 text-2xl font-black text-cyan-200">{mlResult.risk_level}</p>
              </div>
            </div>
          )}
        </div>
